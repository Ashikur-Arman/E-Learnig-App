...
class _BiologyState extends State<Biology> {
  ...
  final String pdfUrl = 'https://drive.google.com/uc?export=download&id=1TD0AasAzNOSN--bRxUMGYBEs5WMPR73C';
  ...
  Future<void> downloadAndLoadPDF() async {
    try {
      ...
      final file = File("${tempDir.path}/biology.pdf");
