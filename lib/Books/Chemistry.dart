...
class _ChemistryState extends State<Chemistry> {
  ...
  final String pdfUrl = 'https://drive.google.com/uc?export=download&id=1O3wCK6YFHU1Y07IOebtiIYgc8_KvnUMJ';
  ...
  Future<void> downloadAndLoadPDF() async {
    try {
      ...
      final file = File("${tempDir.path}/chemistry.pdf");
