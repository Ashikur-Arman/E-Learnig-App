...
class VideoPlayerPage_biology extends StatefulWidget {
  final List<dynamic> playlist;
  final int initialIndex;

  const VideoPlayerPage_biology({
    Key? key,
  ...
  @override
  State<VideoPlayerPage_biology> createState() => _VideoPlayerPageState();
}

class _VideoPlayerPageState extends State<VideoPlayerPage_biology> {
